    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-20 text-sm '>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>54709 Patel Station <br />Suite 350,Kolkata,India</p>
          <p className='text-gray-500'>Tel:(414) 555-6903 <br />Email:prescriptoSupport.@gmail.com </p>
